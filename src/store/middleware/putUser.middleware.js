...
import { putUser, putUserFake } from '../../api/requestServer/putUser';
...
const putUserLogic = (func, dispatch, userData, code, state) => {
...
export const putUserDispath = (userData, code) => {
  return function (dispatch, getState) {
    ...
    const typeFunc = isFakeServer ? putUserFake : putUser;

    console.log(code);
    putUserLogic(typeFunc, dispatch, userData, code, state);
  };
};
